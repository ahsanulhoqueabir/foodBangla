...
const AuthProvider = ({ children }) => {
  ...
  useEffect(() => {
    fetch("https://food-ebon-alpha.vercel.app/thumb")
      .then((res) => res.json())
      .then((data) => setThum(data));
  }, []);

  useEffect(() => {
    fetch("https://food-ebon-alpha.vercel.app/dietplan")
      .then((res) => res.json())
      .then((data) => setDietData(data));
  }, []);
  useEffect(() => {
    fetch("https://food-ebon-alpha.vercel.app/chefs")
      .then((res) => res.json())
      .then((data) => setChefs(data));
  }, []);
  useEffect(() => {
    fetch("https://food-ebon-alpha.vercel.app/blog1")
      .then((res) => res.json())
      .then((data) => setBlog1(data));
  }, []);
  useEffect(() => {
    fetch("https://food-ebon-alpha.vercel.app/blog2")
      .then((res) => res.json())
      .then((data) => setBlog2(data));
  }, []);
  useEffect(() => {
    fetch("https://food-ebon-alpha.vercel.app/blog3")
      .then((res) => res.json())
      .then((data) => setBlog3(data));
  }, []);
  useEffect(() => {
    fetch("https://food-ebon-alpha.vercel.app/blog4")
      .then((res) => res.json())
      .then((data) => setBlog4(data));
  }, []);
  useEffect(() => {
    fetch("https://food-ebon-alpha.vercel.app/allRecipes")
      .then((res) => res.json())
